...
Grote opruiming van voetbalschoenen aan €30.`,
    ...
    manualFacebookPostImport(
        '20% korting op interclub outfits! Nu bij Ren: 20% korting bij elke aankoop van minstens 2 tennis outfits voor Interclub teams.',
        '2019/03/10',
        '/img/headers/duo_interclub.jpg'
    ),
    // manualFacebookPostImport(
