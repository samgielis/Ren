...
import {ISearchIndex} from "./search-index/search-index";
import {ITokenizer} from "./tokenizer/tokenizer";
import {TfIdfSearchIndex} from "./search-index/tf-idf-search-index";
...
import {SimpleTokenizer} from "./tokenizer/simple-tokenizer";
/**
...
export class Search {
    ...
    private indexDocuments_(documents:Array<Object>, searchableFields:Array<string|Array<string>>):void {
        ...
        for (var di = 0, numDocuments = documents.length; di < numDocuments; di++) {
            ...
            var uid:string = (<any>document)[this.uidFieldName_];
